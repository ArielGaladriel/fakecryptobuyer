...
class CustomUser(AbstractBaseUser, PermissionsMixin):
    ...
    pocket = models.JSONField(verbose_name = "user pocket", default = dict)
...
class CryptoData(models.Model):
    crypto_name = models.CharField(max_length=100, unique=True, primary_key=True, verbose_name = "id name of cryptocurrency")
